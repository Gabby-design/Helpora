            ...
            <div className="bg-white rounded-2xl border border-neutral-200 p-6 shadow-sm sticky top-20">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs rounded-xl shadow-sm transition flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  {submitting ? (
                    'Recording Report...'
                  ) : (
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                {reports.map((r) => {
                  // Normalize into the 4 official statuses: Submitted, Under Review, In Progress, Resolved
                  ...
                  } else if (rawStatus === 'in progress' || rawStatus === 'in_progress' || rawStatus === 'working') {
                    statusLabel = 'In Progress';
                    statusClass = 'bg-purple-50 text-purple-700 border-purple-200';
                  } else if (rawStatus === 'under review' || rawStatus === 'under_review' || rawStatus === 'investigating') {
                  ...
                  return (
                    <div key={r.id} className="bg-white rounded-2xl border border-neutral-200 p-5 shadow-sm space-y-3">
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <span className={`text-[10px] font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-full border ${statusClass}`}>
                          {statusLabel}
                        </span>
                      </div>
