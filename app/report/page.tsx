    ...
    <div className="min-h-screen bg-neutral-50 pb-20">
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        <div className="bg-white rounded-2xl border border-neutral-200 p-6 md:p-8 shadow-sm">
          ...
          <div className="my-6 p-4 rounded-xl bg-amber-50 border border-amber-200 text-amber-900 text-xs leading-relaxed">
            <strong>Confidential Submission:</strong> All reports are reviewed by CivicTrust compliance officers. Your identity is kept strictly confidential and will never be disclosed to the reported entity without your written permission.
          </div>
          ...
          {submitted ? (
            <div className="p-8 bg-emerald-50 border border-emerald-200 rounded-2xl text-center space-y-3">
              ...
              <p className="text-xs text-emerald-800 leading-relaxed max-w-md mx-auto">
                Thank you for protecting our community. Our verification committee has opened an investigation file for &quot;{targetName}&quot;. We will review any transaction logs provided.
              </p>
              <Link
                href="/"
                className="mt-4 inline-block px-5 py-2.5 bg-neutral-900 hover:bg-black text-white text-xs font-bold rounded-xl transition"
              >
                Return to CivicTrust Home
              </Link>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 bg-neutral-50 border border-neutral-300 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-rose-600"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., QuickFix Electricals"
                    className="w-full px-3.5 py-2.5 bg-neutral-50 border border-neutral-300 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-rose-600 focus:bg-white"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Detail the timeline, what was promised versus delivered, amounts paid, and any receipts or messages you retain..."
                  className="w-full px-3.5 py-2.5 bg-neutral-50 border border-neutral-300 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-rose-600 focus:bg-white"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full py-3 bg-rose-700 hover:bg-rose-800 text-white font-bold text-xs rounded-xl shadow-sm transition flex items-center justify-center gap-2"
              >
                <Send className="w-3.5 h-3.5" />
                Submit Incident Report to Audit Committee
              </button>
            </form>
          )}
        </div>
